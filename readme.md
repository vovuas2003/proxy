...
* Linux: check Makefile (make help)

* Windows: check bat files in win_scripts
...
In general, all programs expect two command line arguments (ip and port) separated by spaces.
...
google-chrome-stable - example for Linux
